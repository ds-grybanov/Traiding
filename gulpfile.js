...
function scripts(){
    return src([
        'node_modules/jquery/dist/jquery.js', 'node_modules/jquery-match-height/dist/jquery.matchHeight.js',
        'app/js/main.js', 'app/js/slick.min.js', 'app/js/jquery.nice-select.min.js'
